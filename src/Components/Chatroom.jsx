...
export default function Chatroom() {
  return (
    ...
    <div className="bg-[#003366] text-white text-center p-4 w-[100%] fixed top-0 left-0 z-index-100">
        <h4 className="m-0 text-black text-center font-bold">Chat Room</h4>
    </div>
            ...
            <div className="bg-[#A8E4F2] fixed top-14 left-0 h-[calc(100vh-60px)] w-48 min-h-[100vh] p-5 float-left overflow-y-auto">
                <div className='flex flex-col p-4 space-y-4'>
                    {/* <div class="logo">
                      ...
                      <div className="block m-4 font-bold text-[1rem] text-[#003366]">
                    ...
                    <Link to="/" className="bg-white text-black font-bold p-10-20 border-r-8 inline-block">Logout</Link>
