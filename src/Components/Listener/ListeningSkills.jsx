          ...
          <div className="flex flex-wrap justify-center gap-6 max-w-6xl mx-auto">
            ...
            <div className="w-full sm:w-[45%] lg:w-[30%] bg-yellow-50 p-6 rounded-xl shadow">
              ...
              <ul className="list-disc ml-5 space-y-1 text-sm">
                ...
                <li>
                  Avoid personal advice or solutions; focus on facilitating
                  conversation.
                </li>
              </ul>
            </div>
            ...
            <div className="w-full sm:w-[45%] lg:w-[30%] bg-purple-50 p-6 rounded-xl shadow">
              ...
              <ul className="list-disc ml-5 space-y-1 text-sm">
                <li>
                  <strong>Confidentiality:</strong> Maintain strict
                  confidentiality about all conversations.
                </li>
                <li>
                  <strong>Respect Differences:</strong> Be aware of and respect
                  cultural, gender, age, social, and personal differences.
                </li>
              </ul>
            </div>
            ...
            <div className="w-full sm:w-[45%] lg:w-[30%] bg-red-50 p-6 rounded-xl shadow">
              ...
              <ul className="list-disc ml-5 space-y-1 text-sm">
                ...
                <li>
                  If needed, contact local crisis services or emergency contacts
