  ...
  return (
    <div className="w-64 bg-[#A8E4F2] h-[calc(100vh-64px)] sticky top-16 flex flex-col px-4 py-6 overflow-y-auto">
      ...
      <div className="flex flex-col space-y-3 mb-auto">
        ...
        <Link to="/CoordinatorListenerChatroom" className={`px-4 py-2 rounded-full text-center shadow whitespace-nowrap ${getLinkStyle("/CoordinatorListenerChatroom")}`}>
          Listener Chat room
        </Link>
        <Link to="/CoordinatorImageGallery" className={`px-4 py-2 rounded-full text-center shadow whitespace-nowrap ${getLinkStyle("/CoordinatorImageGallery")}`}>
          Image Gallery
        </Link>
